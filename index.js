...
var JSONObj = { "Carbon Copy" : 1981, "A Soldier Story" : 1984, "Power" : 1986, "Cry Freedom" : 1987, "For Queen and Countryy" : 1988};
...
const capitals = debaters.map(upp => upp.toUpperCase());
...
for( var i = 0; i < directors.length; i++){ 
  ...
  if ( directors[i] === "ridleyscott") { 

    var secondDirector = directors.splice(i, 1); 
  }
...
// I'm very proud of my messenger chatbot than can give informations about miyazaki'movies

// Q18. Describe an ESILV project that you worked on that you’re not so proud of?

// my min max power4 because we arrive third place of the class ;()

// Q19. What are some things you like about the developer tools you use?

// i like visual code it s nice to have many files and also docker same reason because makes life simpler
...
// because we have al the tools to make some applications on the web now !!!
